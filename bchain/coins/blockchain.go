...
import (
	...
	"github.com/trezor/blockbook/bchain/coins/sinovate"
)
...
func init() {
	...
	BlockChainFactories["Sinovate"] = sinovate.NewSinovateRPC
	BlockChainFactories["Sinovate Testnet"] = sinovate.NewSinovateRPC
